...
** The content of the env.conf files
   ...
   Each section may be repeated as many times as wanted and they are interpreted in order. For instance, the content
   #+BEGIN_EXAMPLE
   [Prefix]
   FOO=BA
   [Suffix]
