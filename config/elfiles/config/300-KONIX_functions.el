...
(defun konix/notify (msg &optional intrusivity_level remove_date)
  ...
  (cond
   ...
   ((equal intrusivity_level 2)
	(shell-command-to-string (format "konix_display.py -o '%s'" msg))
	)
   ((equal intrusivity_level 3)
	(shell-command-to-string (format "konix_display.py -t annoying -o '%s'" msg))
	(konix/notify msg 1 t)
	)
   ((equal intrusivity_level 4)
	(shell-command-to-string (format "konix_display.py -t boring -o '%s'" msg))
