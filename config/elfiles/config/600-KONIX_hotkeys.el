...
;; ace jump
(define-key 'konix/global-key-map (kbd "M-j") 'ace-jump-mode)
;; flyspell
...
(define-key 'konix/org-global-map "C" 'konix/org/toggle-org-agenda-tag-filter-preset)
(define-key 'konix/org-global-map "R" 'konix/org/record-org-agenda-tag-filter-preset)
