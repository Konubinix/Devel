...
(setq-default org-agenda-diary-file 'diary-file)
(setq-default org-calendar-insert-diary-entry-key (kbd "I"))
(setq-default org-agenda-files (expand-file-name "agenda_files" user-emacs-directory))
