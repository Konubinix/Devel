...
(defun konix/notmuch-search-add-replied ()
  (interactive)
  (konix/notmuch-add-tag "replied")
  (notmuch-search-next-thread)
  )
(defun konix/notmuch-show-add-replied ()
  (interactive)
  (konix/notmuch-add-tag "replied")
  )
...
(define-key notmuch-search-mode-map (kbd "F") 'konix/notmuch-search-unflag-remove-read-and-next)
(define-key notmuch-search-mode-map (kbd "r") 'konix/notmuch-search-add-replied)
(define-key notmuch-show-mode-map (kbd "M")
  'konix/notmuch-show-open-in-external-browser)
(define-key notmuch-show-mode-map (kbd "C-r") 'konix/notmuch-show-add-replied)
