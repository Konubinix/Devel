...
(defun konix/prog/config ()
  ...
  (set (make-local-variable 'konix/check-paren-warn) t)
  (setq ac-sources konix/prog/ac-sources)
  (local-set-key (kbd "M-j") 'c-context-line-break)
  ...
  (if (called-interactively-p)
    ...
    (progn
      ;; So that the local tab-width will take precedance over everything else
