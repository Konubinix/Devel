...
(keymap-set ledger-reconcile-mode-map "*" 'konix/ledger-reconcile-toggle-clear)
(keymap-set ledger-reconcile-mode-map "t" 'konix/ledger-visit-track-mode)
(keymap-set ledger-reconcile-mode-map "s" 'konix/ledger-report-save)
(keymap-set ledger-reconcile-mode-map "w" 'konix/ledger-reconcile-edit-who)
(keymap-set ledger-reconcile-mode-map "W" 'konix/ledger-reconcile-edit-where)
(keymap-set ledger-reconcile-mode-map "E" 'konix/ledger-reconcile-edit)
(keymap-set ledger-reconcile-mode-map "e" 'konix/ledger-reconcile-edit-next-account)
(keymap-set ledger-reconcile-mode-map ";" 'konix/ledger-reconcile-add-note-next-account)
(keymap-set ledger-reconcile-mode-map "<DEL>" 'konix/ledger-reconcile-toggle-up)
(keymap-set ledger-reconcile-mode-map "<SPC>" 'konix/ledger-reconcile-toggle)
(keymap-set ledger-reconcile-mode-map "p" 'konix/ledger-reconcile-move-to-previous-entry)
(keymap-set ledger-reconcile-mode-map "C" 'konix/ledger-report-clean-buffer)
(keymap-set ledger-reconcile-mode-map "u" 'konix/ledger-reconcile-update-track)
