...
# everything else
# ####################################################################################################
DEFAULT_ENV_FILE_NAME = os.path.join(
    os.path.expanduser("~"), ".env_" + sys.platform + ".conf"
)
...
# ####################################################################################################
substitute(
    os.path.join(environ["KONIX_PWD"], "init_bin"),
...
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "mailcap"),
    os.path.join(environ["HOME"], ".mailcap"),
)
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "xscreensaver"),
    os.path.join(environ["HOME"], ".xscreensaver"),
)
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "gitk"),
    os.path.join(environ["HOME"], ".gitk"),
)
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "inputrc"),
    os.path.join(environ["HOME"], ".inputrc"),
)
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "B.blend"),
    os.path.join(environ["HOME"], ".B.blend"),
)
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "screenrc"),
    os.path.join(environ["HOME"], ".screenrc"),
)
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "vimrc"),
    os.path.join(environ["HOME"], ".vimrc"),
)
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "terminator"),
    os.path.join(environ["HOME"], ".config/terminator/config"),
)
substitute(
    os.path.join(environ["KONIX_CONFIG_DIR"], "procmailrc"),
    os.path.join(environ["HOME"], ".procmailrc"),
)
substitute(
    os.path.join(environ["KONIX_SHARE_DIR"], "icons"),
...
if is_on_linux():
    ...
    substitute(
        os.path.join(environ["KONIX_CONFIG_DIR"], "xinitrc"),
    ...
    substitute(
        os.path.join(environ["KONIX_CONFIG_DIR"], "gtkrc-2.0"),
        os.path.join(environ["HOME"], ".gtkrc-2.0"),
    )
    substitute(
        os.path.join(environ["KONIX_CONFIG_DIR"], "rdesktop"),
        os.path.join(environ["HOME"], ".rdesktop"),
    )
    substitute(
        os.path.join(environ["KONIX_CONFIG_DIR"], "starship.toml"),
