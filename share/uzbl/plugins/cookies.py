...
UZBL_COOKIES_FILE = os.environ.get("UZBL_COOKIES_FILE", os.path.join(xdg_data_home, 'uzbl/cookies.txt'))
UZBL_SESSION_COOKIES_FILE = os.environ.get("UZBL_SESSION_COOKIES_FILE", os.path.join(xdg_data_home, 'uzbl/session-cookies.txt'))
DefaultStore = TextStore(UZBL_COOKIES_FILE)
SessionStore = TextStore(UZBL_SESSION_COOKIES_FILE)
